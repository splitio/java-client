...
public class BetweenMatcherTest {
    ...
    public void works() {
        ...
        for (int i = start; i <= end; i++) {
            assertThat(matcher.match(i), is(true));
        }
        assertThat(matcher.match(new Long(start - 1)), is(false));
        assertThat(matcher.match(end + 1), is(false));
    }
    ...
    public void works_dates() {
        ...
        assertThat(matcher.match(april11_2016_23_59), is(false));
