...
public class NotificationParserTest {
    @Test
    public void parse_split_update_should_return_parsed_event() {
    ...
    @Test
    public void parse_split_kill_should_return_parsed_event() {
    ...
    @Test
    public void parse_segment_update_should_return_parsed_event() {
    ...
    @Test
    public void parse_error_should_return_parsed_event() {
    ...
    @Test
    public void parse_incorrect_format_should_return_null() {
        String payload = "{\"id\":\"22\",\"clientId\":\"22\",\"timestamp\":1592591696052,\"encoding\":\"json\",\"channel\":\"xxxx_xxxx_segments\",\"data\":\"{\\\"type\\\":\\\"SEGMENT_UPDATE\\\",\\\"changeNumber\\\":1592591695856,\\\"segmentName\\\":\\\"test-segment\\\"}\"}";
        ...
        result = notificationParser.parse(StreamingConstants.eventMessage, payload);

        assertNull(result);
    }

    @Test
    public void parse_occupancy_control_pri_should_return_parsed_event() {
    ...
    @Test
    public void parse_occupancy_control_sec_should_return_parsed_event() {
    ...
    @Test
    public void parse_control_streaming_paused_should_return_parsed_event() {
    ...
    @Test
    public void parse_control_streaming_resumed_should_return_parsed_event() {
    ...
    @Test
    public void parse_control_streaming_disabled_should_return_parsed_event() {
