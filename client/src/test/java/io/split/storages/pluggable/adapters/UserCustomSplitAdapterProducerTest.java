...
public class UserCustomSplitAdapterProducerTest{
    ...
    public void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        userCustomSplitAdapterProducer.set(_userCustomSplitAdapterProducer, userStorageWrapper);
    }

    @Test
    public void testGetChangeNumber() {
        Mockito.when(userStorageWrapper.get(PrefixAdapter.buildSplitChangeNumber())).thenReturn(UserCustomSplitAdapterConsumerTest.getLongAsJson(120L));
        Assert.assertEquals(120L, _userCustomSplitAdapterProducer.getChangeNumber());
        Mockito.verify(userStorageWrapper, Mockito.times(1)).get(Mockito.anyString());
    }

    @Test
    public void testGetChangeNumberWithWrapperFailing() {
        Mockito.when(userStorageWrapper.get(PrefixAdapter.buildSplitChangeNumber())).thenReturn(null);
    ...
    public void testGetChangeNumberWithGsonFailing() {
        Mockito.when(userStorageWrapper.get(PrefixAdapter.buildSplitChangeNumber())).thenReturn("a");
        Assert.assertEquals(-1L, _userCustomSplitAdapterProducer.getChangeNumber());
        Mockito.verify(userStorageWrapper, Mockito.times(1)).get(Mockito.anyString());
    }
    ...
    public void testRemove() {
        ...
        Mockito.when(userStorageWrapper.get(PrefixAdapter.buildSplitKey(SPLIT_NAME)))
                .thenReturn(UserCustomSplitAdapterConsumerTest.getSplitAsJson(split));
        Mockito.when(userStorageWrapper.decrement(Mockito.anyString(), Mockito.anyLong()))
                .thenReturn(0L);
        _userCustomSplitAdapterProducer.remove(SPLIT_NAME);
        Mockito.verify(userStorageWrapper, Mockito.times(2)).delete(Mockito.anyObject());
        Mockito.verify(userStorageWrapper, Mockito.times(1)).decrement(Mockito.anyObject(), Mockito.anyLong());
        Mockito.verify(userStorageWrapper, Mockito.times(1)).get(Mockito.anyString());
    }
    ...
    public void testRemoveWithNoDelete() {
        ...
        Mockito.when(userStorageWrapper.decrement(Mockito.anyString(), Mockito.anyLong()))
                .thenReturn(1L);
        _userCustomSplitAdapterProducer.remove(SPLIT_NAME);
        Mockito.verify(userStorageWrapper, Mockito.times(1)).delete(Mockito.anyObject());
        Mockito.verify(userStorageWrapper, Mockito.times(1)).decrement(Mockito.anyObject(), Mockito.anyLong());
        Mockito.verify(userStorageWrapper, Mockito.times(1)).get(Mockito.anyString());
    }
    ...
    public void testRemoveWithWrapperFailing() {
        ...
        Mockito.verify(userStorageWrapper, Mockito.times(0)).delete(Mockito.anyObject());
        Mockito.verify(userStorageWrapper, Mockito.times(0)).decrement(Mockito.anyObject(), Mockito.anyLong());
        Mockito.verify(userStorageWrapper, Mockito.times(1)).get(Mockito.anyString());
    }
    ...
    public void testSetChangeNumber()  {
        ...
        Mockito.verify(userStorageWrapper, Mockito.times(1)).set(Mockito.anyString(), Mockito.anyString());
    }

    @Test
    public void testKill() {
        Mockito.when(userStorageWrapper.get(PrefixAdapter.buildSplitKey(SPLIT_NAME))).thenReturn(UserCustomSplitAdapterConsumerTest.getSplitAsJson(getSplit(SPLIT_NAME)));
    ...
    public void testKillSplitNotFound() {
        Mockito.when(userStorageWrapper.get(PrefixAdapter.buildSplitKey(SPLIT_NAME))).thenReturn(null);
        _userCustomSplitAdapterProducer.kill(SPLIT_NAME, "DefaultTreatment", 2L);
        Mockito.verify(userStorageWrapper, Mockito.times(1)).get(Mockito.anyString());
        Mockito.verify(userStorageWrapper, Mockito.times(0)).set(Mockito.anyString(), Mockito.anyString());
    }
    ...
    public void testPutMany() {
        ...
        Mockito.verify(userStorageWrapper, Mockito.times(2)).set(Mockito.anyString(), Mockito.anyString());
        Mockito.verify(userStorageWrapper, Mockito.times(2)).increment(Mockito.anyString(), Mockito.anyLong());
    ...
    public void testIncreaseTrafficType() {
        ...
        Mockito.verify(userStorageWrapper, Mockito.times(1)).increment(PrefixAdapter.buildTrafficTypeExists("TrafficType"), 1);
    }

    @Test
    public void testDecreaseTrafficType() {
        _userCustomSplitAdapterProducer.decreaseTrafficType("TrafficType");
        Mockito.verify(userStorageWrapper, Mockito.times(1)).decrement(PrefixAdapter.buildTrafficTypeExists("TrafficType"), 1);
        Mockito.verify(userStorageWrapper, Mockito.times(1)).delete(Mockito.anyObject());
