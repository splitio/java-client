...
public class UserCustomSegmentAdapterProducerTest {
    ...
    public void setUp() throws NoSuchFieldException, IllegalAccessException {
        ...
        userCustomSegmentAdapterProducer.set(_userCustomSegmentAdapterProducer, userStorageWrapper);
    }
    ...
    public void testUpdateSegment() {
        ...
        Mockito.verify(userStorageWrapper, Mockito.times(1)).addItems(Mockito.anyString(), Mockito.anyObject());
        Mockito.verify(userStorageWrapper, Mockito.times(1)).removeItems(Mockito.anyString(), Mockito.anyObject());
